...
export function MehndiIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M14.28 20.86a2.5 2.5 0 0 0 3.54 0l1.41-1.41a2.5 2.5 0 0 0 0-3.54l-5.66-5.66a2.5 2.5 0 0 0-3.54 0L8.62 11.6a2.5 2.5 0 0 0 0 3.54l1.41 1.41a2.5 2.5 0 0 0 3.54 0Z" />
      <path d="M17.8 21.2a9 9 0 0 0-11.3-11.3" />
      <path d="m11.3 17.8-2.8-2.8" />
      <path d="m15.2 14-2.8-2.8" />
      <path d="m20 12-2-2" />
      <path d="M7 15s-1.5 1.5-3 0" />
      <path d="M5.5 16.5c-1.5-1.5 0-3 0-3" />
      <path d="M2 22s1.5-1.5 0-3" />
      <path d="M3.5 20.5c1.5-1.5 0-3 0-3" />
    </svg>
  );
}
