                                            ...
                                            <div className="space-y-2">
                                                {artists.map(artist => (
                                                    <div key={`artist-${artist.id}`} className="flex items-center space-x-2">
                                                        <Checkbox id={`artist-${artist.id}`} onCheckedChange={() => handleUserSelection(artist.id)} checked={selectedUsers.includes(artist.id)}/>
                                            ...
                                            <div className="space-y-2">
                                                {customers.map(customer => (
                                                    <div key={`customer-${customer.id}`} className="flex items-center space-x-2">
                                                        <Checkbox id={`customer-${customer.id}`} onCheckedChange={() => handleUserSelection(customer.id)} checked={selectedUsers.includes(customer.id)}/>
